...
const GLOBAL_FORMS = {
  ...
  public_works: [
    {
      ...
      description: 'Registro de medição para liberação de recursos.',
      subspecialties: ['infrastructure', 'maintenance_services'],
      isActive: true,
      items: [
        {
          id: 'milestone_id',
        ...
        },
        {
          ...
          type: 'select',
          options: ['Conforme', 'Com Ressalvas', 'Não Conforme'],
          required: true,
          allowPhotos: true,
        },
        {
          id: 'materials_conformity',
          label: 'Materiais em Conformidade',
          type: 'boolean',
          required: true,
          allowPhotos: true,
        },
        {
          ...
          label: 'Condições de Segurança Adequadas',
          type: 'boolean',
          required: true,
          allowPhotos: true,
        },
    ...
    {
      id: 'vistoria_andamento',
      title: 'Vistoria de Andamento',
      description: 'Registro de vistoria periódica da obra.',
      subspecialties: ['infrastructure', 'maintenance_services'],
      isActive: true,
      items: [
        {
          id: 'site_access',
          label: 'Acesso ao Local Liberado',
          type: 'boolean',
          required: false,
          allowPhotos: false,
        },
        {
          id: 'worker_count',
          label: 'Nº de Trabalhadores no Local',
          type: 'number',
          required: false,
          allowPhotos: false,
        },
        {
          ...
          label: 'Equipamentos no Local',
          type: 'checklist',
          options: ['Betoneira', 'Guindaste', 'Escavadeira', 'Compactador', 'Andaime', 'Outros'],
          required: false,
          allowPhotos: false,
        },
        {
          ...
          type: 'select',
          options: ['No Prazo', 'Atrasado', 'Adiantado'],
          required: true,
          allowPhotos: false,
        },
        {
        ...
        {
          id: 'daily_work_log',
          label: 'Registro de Atividades do Dia',
          type: 'text',
          required: false,
          allowPhotos: false,
        },
        {
          id: 'infrastructure_conditions',
          label: 'Condições de Infraestrutura Adequadas',
          type: 'boolean',
          required: false,
          allowPhotos: true,
        },
    ...
    },
    {
      ...
      description: 'Registro de recebimento provisório ou definitivo da obra.',
      subspecialties: ['infrastructure', 'maintenance_services', 'material_supply'],
      isActive: true,
      items: [
        {
          id: 'reception_type',
          ...
          type: 'select',
          options: ['Provisório', 'Definitivo'],
          required: true,
          allowPhotos: false,
        },
        {
          id: 'scope_compliance',
          label: 'Escopo Atendido Integralmente',
          type: 'boolean',
          required: true,
          allowPhotos: false,
        },
        {
          ...
          label: 'Especificações Técnicas Atendidas',
          type: 'boolean',
          required: true,
          allowPhotos: false,
        },
        ...
        },
        {
          ...
          type: 'select',
          options: ['Aceito', 'Rejeitado', 'Condicional'],
          required: true,
          allowPhotos: false,
        },
        {
    ...
    {
      id: 'checklist_conformidade_legal',
      title: 'Checklist de Conformidade Legal',
      description: 'Verificação de documentação e conformidade da empresa contratada.',
      subspecialties: [],
      isActive: true,
      items: [
        {
        ...
        {
          id: 'safety_plan',
          label: 'Plano de Segurança Apresentado',
          type: 'boolean',
          required: true,
          allowPhotos: false,
        },
        {
          ...
          label: 'Licença Ambiental (se aplicável)',
          type: 'boolean',
          required: false,
          allowPhotos: false,
        },
        {
          ...
          label: 'Registro de Funcionários em Dia',
          type: 'boolean',
          required: true,
          allowPhotos: false,
        },
        {
          id: 'tax_compliance',
          label: 'Certidões Negativas de Débito',
          type: 'boolean',
          required: true,
          allowPhotos: false,
        },
  ...
  // ═══════════════════════════════════════════════════════════
  // GENÉRICO (Para todos os segmentos)
  // ═══════════════════════════════════════════════════════════
  other: [
    {
