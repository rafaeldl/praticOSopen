...
abstract class AppLocalizations {
  ...
  /// No description provided for @deviceStatusInactive.
  ///
  /// In pt, this message translates to:
  /// **'Inativo'**
  String get deviceStatusInactive;

  /// No description provided for @deviceStatusDecommissioned.
  ///
  /// In pt, this message translates to:
  /// **'Desativado'**
  String get deviceStatusDecommissioned;
  ...
  /// No description provided for @recurrenceRules.
  ///
  /// In pt, this message translates to:
  /// **'Regras de recorrência'**
  String get recurrenceRules;

  /// No description provided for @noRecurrenceRules.
  ///
  /// In pt, this message translates to:
  /// **'Nenhuma regra de recorrência'**
  String get noRecurrenceRules;
  ...
  /// No description provided for @recurrenceNextDue.
  ///
  /// In pt, this message translates to:
  /// **'Próxima geração'**
  String get recurrenceNextDue;

  /// No description provided for @recurrenceAutoGenerate.
  ///
  /// In pt, this message translates to:
  /// **'Gerar OS automaticamente'**
  String get recurrenceAutoGenerate;

  /// No description provided for @recurrenceAutoGenerateDescription.
  ///
  /// In pt, this message translates to:
  /// **'Quando ativado, cria a OS automaticamente na data prevista'**
  String get recurrenceAutoGenerateDescription;

  /// No description provided for @recurrenceReminderDays.
  ///
  /// In pt, this message translates to:
  /// **'Lembrete (dias antes)'**
  String get recurrenceReminderDays;
  ...
  /// No description provided for @newRecurrenceRule.
  ///
  /// In pt, this message translates to:
  /// **'Nova Recorrência'**
  String get newRecurrenceRule;

  /// No description provided for @editRecurrenceRule.
  ///
  /// In pt, this message translates to:
  /// **'Editar Recorrência'**
  String get editRecurrenceRule;
